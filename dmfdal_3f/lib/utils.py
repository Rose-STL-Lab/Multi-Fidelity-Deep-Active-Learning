...
def generate_new_trainset(selected_data, previous_data, dataset_dir, **kwargs):
    ...
    selected_x_l3 = selected_data['l3_x']
    selected_y_l3 = selected_data['l3_y']
    ...
    data1['x_train_l3'] = np.concatenate([previous_data['x_train_l3'], selected_x_l3],0)
    data1['y_train_l3'] = np.concatenate([previous_data['y_train_l3'], selected_y_l3],0)
    print('new training data shape: ')
    print(data1['x_train_l1'].shape,data1['y_train_l1'].shape)
    print(data1['x_train_l2'].shape,data1['y_train_l2'].shape)
    print(data1['x_train_l3'].shape,data1['y_train_l3'].shape)
    ...
    data1['l3_train_loader'] = DataLoader(data1['x_train_l3'], data1['y_train_l3'], shuffle=True)

    return data1

def load_dataset(dataset_dir, **kwargs):
    data = {}
    for category in ['train_l1', 'train_l2', 'train_l3', 'test_l1', 'test_l2', 'test_l3']:
    ...
    data['l3_y_ref'] = ref_data['l3_y_ref']
    ...
    l3_y_scaler = StandardScaler(mean=np.mean(data['y_train_l3']), std= np.std(data['y_train_l3']))

    data['x_train_l1'] = l1_x_scaler.transform(data['x_train_l1'])
    data['y_train_l1'] = l1_y_scaler.transform(data['y_train_l1'])
    data['x_train_l2'] = l1_x_scaler.transform(data['x_train_l2'])
    data['y_train_l2'] = l2_y_scaler.transform(data['y_train_l2'])
    data['x_train_l3'] = l1_x_scaler.transform(data['x_train_l3'])
    data['y_train_l3'] = l3_y_scaler.transform(data['y_train_l3'])

    data['x_test_l1'] = l1_x_scaler.transform(data['x_test_l1'])
    data['y_test_l1'] = l1_y_scaler.transform(data['y_test_l1'])
    data['x_test_l2'] = l1_x_scaler.transform(data['x_test_l2'])
    data['y_test_l2'] = l2_y_scaler.transform(data['y_test_l2'])
    data['x_test_l3'] = l1_x_scaler.transform(data['x_test_l3'])
    data['y_test_l3'] = l3_y_scaler.transform(data['y_test_l3'])
    ...
    data['l3_y_ref'] = l3_y_scaler.transform(data['l3_y_ref'])
    ...
    data['l3_train_loader'] = DataLoader(data['x_train_l3'], data['y_train_l3'], shuffle=True)
    ...
    data['l3_test_loader'] = DataLoader(data['x_test_l3'], data['y_test_l3'], shuffle=False)

    data['l1_x_scaler'] = l1_x_scaler
    data['l1_y_scaler'] = l1_y_scaler
    data['l2_y_scaler'] = l2_y_scaler
    data['l3_y_scaler'] = l3_y_scaler
